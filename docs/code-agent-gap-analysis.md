...
> 目标：让 `local-code-agent` 从“可用的本地代码 Agent CLI”进一步演进为更接近成熟代码 Agent 的工程助手。

## 当前已有基础

项目目前已经具备以下代码 Agent 风格能力雏形：
...
当前项目有 REPL，但与成熟代码 Agent 相比，仍缺少更强的交互能力：
...
### 2. 工具原语还不够接近成熟代码 Agent

成熟代码 Agent 的核心不是“会用工具”，而是工具原语足够稳定、通用、细粒度。
...
## Phase 1：先把“用起来像成熟代码 Agent”

### 目标
让用户在终端中的主观体验更接近成熟代码 Agent。
...
### 目标
让项目更接近成熟代码 Agent 在真实代码库中的安全与工程实践。
...
成熟代码 Agent 的像不像，很多时候不只是技术能力，而是：
...
要让它**更像成熟代码 Agent**，最关键不是继续堆功能，而是围绕这四件事持续收敛：
